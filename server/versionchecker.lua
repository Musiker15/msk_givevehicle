    ...
    SetTimeout(1000, function()
        ...
        PerformHttpRequest(GITHUB_API:format(AUTHOR, NAME, FILE), function(status, response, headers)
            ...
            if currentVersion == latestVersion then
                return Config.VersionChecker and
            ...
            for i = 1, #cV do
                ...
                if current ~= latest then
                    if current < latest then
                        ...
                        :format(NAME_COLORED, RESOURCE_NAME, currentVersion, latestVersion, NAME_COLORED,
                            DOWNLOAD:format(AUTHOR, RESOURCE_NAME)))
                        ...
                        if Config.VersionChecker then
                            print(("%s ^3Beta Version detected! ^0[^5Current Version: ^3%s^0 - ^5Latest Version: ^2%s^0] - ^3You can ignore this message!^0")
                            :format(NAME_COLORED, currentVersion, latestVersion))
                        end
